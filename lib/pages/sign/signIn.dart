...
class _SignInState extends State<SignIn> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationLogo = new Tween(begin: -1.0, end: 0.0).animate(
        new CurvedAnimation(parent: controller, curve: Curves.fastOutSlowIn));
    animationUser = new Tween(begin: -1.0, end: 0.0).animate(
        new CurvedAnimation(
            parent: controller,
            curve: Interval(0.2, 1, curve: Curves.fastOutSlowIn)));
    animationPass = new Tween(begin: -1.0, end: 0.0).animate(
        new CurvedAnimation(
            parent: controller,
      ...
      builder: (BuildContext context, child) {
        return new Scaffold(
          ...
          children: <Widget>[
            new Transform(
              transform:
                  Matrix4.translationValues(width * animationLogo.value, 0, 0),
              child: new Center(
                child: new Container(
            ...
            new Transform(
              transform:
                  Matrix4.translationValues(width * animationUser.value, 0, 0),
              child: new Container(
                padding:
                    new EdgeInsets.symmetric(horizontal: 30.0, vertical: 20.0),
                child: new TextField(
                  focusNode: fsNode1,
                  ...
                  decoration: new InputDecoration(
                      prefixIcon: new Icon(Icons.person_outline,
                          size: 35.0, color: Color(0xFF393939)),
                      hintText: 'UserName'),
                  onEditingComplete: () {
            ...
            new Transform(
              transform:
                  Matrix4.translationValues(width * animationPass.value, 0, 0),
              child: new Container(
            ...
            new Transform(
              transform:
                  Matrix4.translationValues(width * animationBtn.value, 0, 0),
              child: new Container(
                ...
                child: new RaisedButton(
                  ...
                  onPressed: () async {
//                    var hu = new httpUtil();
//                    hu.baseUrl = 'https://manage.caredaily.com/api/v1/';
//                    var res = await hu.Post("agent/agenttoken", {}, {
...
//                    }
            ...
            new Transform(
                ...
                child: new Container(
                  margin:
                      new EdgeInsets.only(left: 150.0, right: 150.0, top: 80.0),
                  child: new OutlineButton(
                    ...
                    child: new Text(
                      'SIGNUP',
                      style: new TextStyle(
                          color: Color(0xFFbcbcbc), fontSize: 12.0),
                    ),
                    onPressed: () {
